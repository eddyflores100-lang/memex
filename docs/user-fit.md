...
| Your situation | 0.3.0rc1 fit | What you get | Boundary to know |
|---|---|---|---|
...
| Codex or Claude Code user who wants memory across sessions | Yes | A supported MCP installation path and recall, store, and correction tools | The client decides when to call the tools |
...
| User who cannot run Ollama or download the embedding model | No | — | 0.3.0rc1 does not provide a hosted embedding or memory service |
