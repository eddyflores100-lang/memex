# Benchmark Integrity Audit — Memex 95.11% on LongMemEval_S
...
**Problem:** The source of Mastra's 94.87% figure is not formally cited anywhere in the Memex repo. The figure appears in `LAUNCH_DEFENSE.md` as a reference point but without a URL, paper, or dataset version.
