...
https://github.com/eddyflores100-lang/memex`` and the geminicli.com gallery
...
def test_manifest_launches_the_registry_published_package():
    ...
    entry = manifest["mcpServers"]["memex"]
...
def test_context_file_names_only_tools_the_server_exposes():
    ...
    named = set(re.findall(r"`(memex_[a-z_]+)`", (ROOT / "GEMINI.md").read_text()))
...
def test_reference_documents_the_extension_install_command():
    ...
    assert "gemini extensions install https://github.com/eddyflores100-lang/memex" in readme
