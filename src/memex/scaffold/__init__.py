"""memex.scaffold — drift-safe QA system-prompt wrapper for retrieved memory.

The Memex QA scaffold technique: a versioned, bounded, idempotent system-prompt
wrapper that lifts QA accuracy on retrieval-augmented questions without modifying
the underlying LLM. Composes with Memex retrieval (BM25 + temporal-boost +
