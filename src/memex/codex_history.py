...
Normal durable recall remains the Memex corpus. This adapter is consulted
...
def is_codex_history_query(text: str) -> bool:
    ...
    Deliberately unchanged: `memex.server` also uses this predicate to promote
...
def _query_terms(text: str) -> set[str]:
    from memex.session_reference import content_terms, parse_session_reference
...
def _score(query: str, text: str) -> float:
    from memex.session_reference import canonical_topic_term
