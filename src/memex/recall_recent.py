...
applies the deterministic reference rules in `memex.session_reference`, and
...
from memex.session_reference import (
    SessionReference,
    local_day,
...
def _session_evidence_text(result) -> str:
    ...
    on identical text."""
    from memex.recall_sessions import session_evidence_text
