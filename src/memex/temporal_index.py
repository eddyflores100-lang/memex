...
if TYPE_CHECKING:  # lazy at runtime — memex.temporal lands independently
    from memex.temporal import SupersessionIndex
...
class TemporalIndex:
    ...
    def status_counts(self, *, now: str) -> dict[str, int]:
        ...
        matches :func:`memex.temporal.temporal_status`: superseded >
    ...
    def supersession_index(self) -> SupersessionIndex:
        ...
        # (dedup keeps working) even if memex.temporal is absent or broken.
        from memex.temporal import SupersessionIndex
