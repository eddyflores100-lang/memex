...
SCHEMA_VERSION = "memex.relation-envelope/v2"
LEGACY_SCHEMA_VERSION = "memex.relation-envelope/v1"
...
def build_relation_envelope(
    *,
    ...
    return {
        ...
        "extractor": {
            "name": "memex-deterministic-relation-extractor",
...
def dry_run_backfill_relation_envelopes(
    ...
    *,
    ...
    return {
        "schema_version": "memex.relation-backfill-dry-run/v2",
