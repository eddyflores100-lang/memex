...
_DEFAULTS: dict[str, Any] = {
    ...
    # boundary and does not make memex multi-user. See agents.md.
    "user_id": "agent",
    "recall_limit": 50,
    ...
    # Hybrid retrieval tuning (see memex.recall_hybrid)
...
_ENV_MAP = {
    ...
    # Flagship tier (see memex.recall_hybrid)
...
def load(config_path: str | Path | None = None) -> dict[str, Any]:
    ...
    if cfg.get("llm_model") == "mistral:7b":
        print(
            "[memex] WARNING: ~/.cogito/config.json pins llm_model=mistral:7b "
