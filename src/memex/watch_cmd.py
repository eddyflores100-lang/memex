"""memex watch — auto-ingest new markdown/text files from a directory.
...
- Idempotent: tracks ingested file hashes in ~/.memex/watched.json
"""
...
LEDGER_PATH = Path.home() / ".memex" / "watched.json"
        ...
        while True:
            ...
            if bytes_remaining <= 0:
                print(
                    ...
                    "Restart `memex watch` to begin a new session.",
                    file=sys.stderr,
                )
                return 0
