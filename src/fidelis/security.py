"""fidelis.security — rate limiting and security headers for the HTTP server.
...
Usage in server.py:
    from fidelis.security import RateLimiter, security_headers
...
def add_security_headers(handler) -> None:
    ...
    handler.send_header("Server", "fidelis-alicelabs")
